...
def load_ccds(
    ...
    **kwd,
    ...
    """Simple recursion of `~fitsmgmt.hduutil.load_ccd`
...
def errormap(
    ...
    subtracted_dark : array-like, optional.
...
from .wcstools import center_radec, fov_radius, pixel_scale, wcs_crota, wcsremove
...
def give_stats(
    ...
    statsecs : `str`, slice, `int`, `list` of such, optional.
        ...
        etc.). See `~astro_ndslice.slicefy` for more details.
        Default: `None`.
    ...
    N_extrema : `int`, optinoal, optional.
